...
class SE_Res101UNet(nn.Module):
    def __init__(self, num_classes=4, num_filters=32,
                 pretrained='imagenet', is_deconv=False,cls_only=False):

        super().__init__()
        self.num_classes = num_classes
        self.pool = nn.MaxPool2d(2, 2)
        self.encoder = se_resnext101_32x4d(pretrained=pretrained)
